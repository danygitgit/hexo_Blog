---
# 文章标题，强烈建议填写此选项
title: Vue小白课（二）——项目结构解析（Vue2.x）
#	发布时间，强烈建议填写此选项，且最好保证全局唯一
date: 2019-07-22 14:02:55
# 文章作者
author: db
...
summary: 在上一篇项目搭建文章中，我们已经下载安装了node环境以及vue-cli，并且已经成功构建了一个vue-cli项目——见【Vue小白课（一）——CLI搭建项目（Vue2.x）】。那么接下来，我们来梳理一下vue-cli项目的结构。
